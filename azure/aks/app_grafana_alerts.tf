...
#       datasource_uid = "PBFA97CFB590B2093"
#       model          = "{\"datasource\":{\"type\":\"prometheus\",\"uid\":\"PBFA97CFB590B2093\"},\"editorMode\":\"code\",\"exemplar\":true,\"expr\":\"sum(kube_node_status_condition{condition=\\\"Ready\\\", status=\\\"false\\\"})\",\"interval\":\"\",\"intervalMs\":15000,\"legendFormat\":\"\",\"maxDataPoints\":43200,\"range\":true,\"refId\":\"A\"}"
#     }
#     data {
#       ref_id = "B"
