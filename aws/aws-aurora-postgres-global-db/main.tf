...
resource "aws_rds_global_cluster" "rds_global_cluster" {
  global_cluster_identifier    = "global-db-${var.microservice_name}"
  force_destroy                = true
...
resource "aws_rds_cluster" "aurora" {
  ...
  lifecycle {
    ignore_changes = [
      availability_zones, global_cluster_identifier, replication_source_identifier, snapshot_identifier
    ]
  }
